/**
 * Card-reading interface for retail POS hardware -- HONEST PLACEHOLDER,
 * not a real integration. Deliberately different situation from
 * terminal-app's p18qTerminal.ts: for the taxi P18Q, a real vendor SDK
 * exists and is genuinely integrated (see
 * android/app/src/main/java/za/co/vink/app/terminal/P18QTerminalPlugin.java
 * in the main repo). For this retail hardware, no vendor has been
 * confirmed and no SDK exists yet -- you told me directly ("build the
 * software side first, hardware integration comes later").
 *
 * This file exists so the rest of the app (screens, backend
