 ...
 * plugin (android/app/src/main/java/za/co/vink/terminal/
 * P18QTerminalPlugin.java) -- bridges to the P18Q bus validator's
 * built-in contactless card reader, using the real Deka EMV SDK
 * (provided 2026-08-17). Same plugin code as the main VINK app --
 * copied here since this is a deliberately separate, standalone
 * Capacitor project (its own package name, its own Play Store
 * listing), not sharing a build with the consumer-facing VINK app.
 *
