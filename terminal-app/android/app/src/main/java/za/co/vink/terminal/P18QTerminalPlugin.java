...
/**
 * Bridges the web app (terminal-app/src/services/p18qTerminal.ts) to
 * the P18Q's built-in contactless card reader, using the real Deka EMV
 * SDK (android/app/libs/visa_master_library-release.aar,
 * dc_reader_release_20240221112325.aar, utils-1.0.3.aar,
 * business-1.0.1.jar -- from the SDK archive provided 2026-08-17).
 * This is the standalone VINK Terminal app (za.co.vink.terminal) --
 * same plugin code as the main VINK app's copy, but this app has no
 * banking/marketplace/dashboard code at all, only terminal setup and
 * tap collection.
 *
