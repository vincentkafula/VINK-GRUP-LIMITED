...
import rideRelayRouter from "./routes/rideRelayRouter.js";
import rideHailingRouter from "./routes/rideHailingRouter.js";
...
app.use("/api/rides",         rideRelayRouter);
app.use("/api/rides",         rideHailingRouter);
