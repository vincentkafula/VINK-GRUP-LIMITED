...
export interface UnifiedAccount {
  id: string;
  referenceNumber: string;   // e.g. MANSHYA-GBL-2024-00001
  customerId: string;
  customerName: string;
  email: string;
  phone: string;
...
export interface NostroAccount {
  ...
  swiftBic: string;
  balance: number;            // MANSHYA's own funds in that country
...
export interface GlobalTransaction {
  ...
  interchangeEarned: number;   // MANSHYA income on this txn
