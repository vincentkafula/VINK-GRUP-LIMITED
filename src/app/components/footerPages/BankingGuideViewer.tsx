...
const STEPS = [
  ...
  { n: "2", title: "Get your card", desc: "Your MANSHYA card is issued digitally the moment your account is approved, so you can start using it in the app immediately while your physical card is on its way." },
  { n: "3", title: "Tap, pay, and track", desc: "Tap your card at any MANSHYA-enabled taxi, retailer, or partner merchant. Every transaction shows up in the app in real time — no waiting for statements." },
...
const TOPICS = [
  { icon: "💳", title: "Understanding your card", desc: "How your MANSHYA card works, what tap-and-go actually does, and how to read a transaction on your statement." },
  { icon: "📱", title: "Using the MANSHYA app", desc: "Navigating your dashboard, setting up notifications, and finding your virtual card details for online purchases." },
      ...
      <div className="py-16 px-6 text-white" style={{ background: `linear-gradient(135deg,#0F172A,${P})` }}>
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-white/75 text-lg max-w-2xl leading-relaxed">
            Everything you need to know to get comfortable with MANSHYA, from opening your account to using your card every day.
          </p>
        </div>
      </div>
      ...
      <div className="max-w-4xl mx-auto w-full px-5 py-10 space-y-10">
        ...
        <section className="rounded-2xl p-5" style={{ background: "#FEF3C7", border: "1px solid #FDE68A" }}>
          <p className="text-sm font-semibold" style={{ color: "#92400E" }}>
            MANSHYA is not yet in full operation. This guide describes how MANSHYA will work once we launch in June 2027 — you're welcome to read through it now, but accounts and cards aren't active yet.
          </p>
        </section>
