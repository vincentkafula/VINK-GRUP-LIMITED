...
const THEMES = [
  ...
  { icon: "💡", title: "Financial Inclusion", desc: "How digital payment infrastructure can reach people traditional banking has left out — the thinking behind why MANSHYA exists." },
    ...
    <div className="fixed inset-0 z-50 flex flex-col overflow-y-auto bg-white">
      ...
      <div className="py-16 px-6 text-white" style={{ background: `linear-gradient(135deg,#0F172A,${P})` }}>
        <div className="max-w-4xl mx-auto">
          ...
          <h1 className="text-4xl font-black mb-3">The MANSHYA Blog</h1>
          <p className="text-white/75 text-lg max-w-2xl leading-relaxed">
            Stories, insights, and practical guidance for the people MANSHYA is built for.
          </p>
        </div>
      </div>
      ...
      <div className="max-w-4xl mx-auto w-full px-5 py-10 space-y-10">
        ...
        <section className="rounded-2xl p-5" style={{ background: "#FEF3C7", border: "1px solid #FDE68A" }}>
          <p className="text-sm font-semibold" style={{ color: "#92400E" }}>
            The blog hasn't published yet — MANSHYA is not currently in full operation. The first posts go live alongside our June 2027 launch. What follows is a preview of what we'll be writing about.
          </p>
        </section>
        ...
        <section className="bg-gray-50 rounded-2xl p-6 border border-gray-200">
          ...
          <p className="text-gray-600 text-sm leading-relaxed">
            We'll announce the blog's launch through our usual channels. In the meantime, MANSHYA at the World Economic Forum and Social Responsibility already share some of the thinking behind why we're building MANSHYA the way we are.
          </p>
        </section>
      </div>
