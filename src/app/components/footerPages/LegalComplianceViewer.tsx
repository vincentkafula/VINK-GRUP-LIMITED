      ...
      <div className="max-w-4xl mx-auto w-full px-5 py-10">
        ...
        {activeTab === "privacy" && (
          <div className="space-y-6">
            ...
            <div className="bg-white rounded-2xl border border-gray-200 p-6 space-y-4 text-sm text-gray-700 leading-relaxed">
              <p>MANSHYA collects personal information including your name, ID number, contact details, and transaction history for the purposes of providing financial services, fraud prevention, and regulatory compliance.</p>
              ...
              <p>MANSHYA complies fully with the <strong>Protection of Personal Information Act (POPIA), Act 4 of 2013</strong>.</p>
            </div>
          </div>
        )}
        ...
        {activeTab === "terms" && (
          <div className="space-y-6">
            ...
            <div className="bg-white rounded-2xl border border-gray-200 p-6 space-y-4 text-sm text-gray-700 leading-relaxed">
              <p>The MANSHYA website and mobile application are provided for <strong>lawful personal and business use only</strong>.</p>
              <p>Unauthorised access, scraping, reverse engineering, or use of MANSHYA intellectual property without written permission is prohibited.</p>
              <p>MANSHYA reserves the right to suspend access to any user who breaches these terms. Full terms available at <span className="font-semibold" style={{ color: P }}>vink.co.za/terms</span>.</p>
        ...
        {activeTab === "regulatory" && (
          <div className="space-y-6">
            ...
            <div className="bg-white rounded-2xl border border-gray-200 p-6 space-y-4 text-sm text-gray-700 leading-relaxed">
              <p>MANSHYA operates in accordance with:</p>
        ...
        {activeTab === "compliance" && (
          <div className="space-y-6">
            ...
            <div className="bg-white rounded-2xl border border-gray-200 p-6 space-y-4 text-sm text-gray-700 leading-relaxed">
              ...
              <p><strong>Customer Due Diligence:</strong> MANSHYA conducts FICA-compliant Know Your Customer (KYC) verification for all account holders, including identity verification, address verification, and ongoing transaction monitoring.</p>
