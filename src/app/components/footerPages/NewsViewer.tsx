...
const ARTICLES = [
  {
    ...
    category: "Product News", date: "March 2022", author: "VINK Editorial Team", featured: true,
  ...
  },
  {
    ...
    category: "Partnerships", date: "November 2021", author: "VINK Editorial Team", featured: false,
  ...
  },
  {
    ...
    category: "Technology", date: "September 2021", author: "VINK Tech Team", featured: false,
  ...
  },
  {
    ...
    category: "Product News", date: "July 2020", author: "VINK Editorial Team", featured: false,
  ...
  },
  {
    ...
    category: "Community Impact", date: "March 2020", author: "VINK Editorial Team", featured: false,
  ...
  },
  {
    ...
    category: "Regulatory Update", date: "January 2022", author: "VINK Corporate Team", featured: false,
    ...
    <div className="fixed inset-0 z-50 flex flex-col overflow-y-auto bg-gray-50">
      ...
      <div className="py-12 px-6 text-white" style={{ background: `linear-gradient(135deg,${P},#7B4DB5)` }}>
        <div className="max-w-5xl mx-auto">
          ...
          <p className="text-white/70 text-sm">Product updates, community impact, and industry insights from VINK.</p>
        </div>
      </div>
      ...
      <div className="max-w-5xl mx-auto w-full px-5 py-8 space-y-8">
        ...
        <div className="rounded-2xl p-8 text-white text-center" style={{ background: `linear-gradient(135deg,${P},#7B4DB5)` }}>
          ...
          <p className="text-white/75 text-sm mb-6 max-w-md mx-auto">
            VINK news, product launches, and industry insights — delivered to your inbox monthly.
          </p>
