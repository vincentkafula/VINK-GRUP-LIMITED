...
const ACCOUNT_FEES = [
  { product: "MANSHYA Commuter Card", monthly: "R0", note: "No monthly fee, ever." },
  ...
  { product: "MANSHYA Gold (Visa Infinite Elite)", monthly: "Premium annual fee applies", note: "Full fee schedule published at launch." },
];

const TRANSACTION_FEES = [
  { item: "Taxi fare tap (MANSHYA Commuter Card)", fee: "R0.50 per transaction" },
      ...
      <div className="py-16 px-6 text-white" style={{ background: `linear-gradient(135deg,#0F172A,${P})` }}>
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-white/75 text-lg max-w-2xl leading-relaxed">
            A clear, upfront look at what MANSHYA products cost — and what stays free.
          </p>
        </div>
      </div>
      ...
      <div className="max-w-4xl mx-auto w-full px-5 py-10 space-y-10">
        ...
        <section className="rounded-2xl p-5" style={{ background: "#FEF3C7", border: "1px solid #FDE68A" }}>
          <p className="text-sm font-semibold" style={{ color: "#92400E" }}>
            MANSHYA is not yet in full operation. The figures below reflect our published product design and are confirmed in full when we launch in June 2027 — nothing on this page can be paid or activated today.
          </p>
        </section>
        ...
        <section className="bg-gray-50 rounded-2xl p-6 border border-gray-200">
          ...
          <p className="text-gray-600 text-sm leading-relaxed">
            MANSHYA was built for people who currently pay too much to move money — taxi commuters, drivers, and small operators. Wherever possible, our pricing is designed to undercut traditional banking fees on the transactions that matter most to the people we serve, starting with the daily taxi fare tap.
          </p>
        </section>
      </div>
