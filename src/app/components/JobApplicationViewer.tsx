...
const DEPARTMENTS: Department[] = [
  ...
  { id: "news", code: "NM", name: "News Management",
    positions: [
      "General Manager", "Editor-in-Chief", "Managing Editor", "Section Editor",
      "Copy Editor / Sub-editor", "Reporter / Journalist", "Photojournalist / Photo Editor", "Layout / Design Editor",
      "Advertising / Sales Manager", "Marketing Manager", "Circulation Manager", "Finance / Accounts Manager", "HR Manager",
      "Print Production Manager", "IT / Web Manager", "Digital Editor",
      "Legal Advisor", "Proofreader", "Administrative Staff",
    ],
