...
const ROW1 = [
  ...
  { name: "Fuel Rewards",     price: "R85",  features: ["Earn 8c per litre at Engen, Shell, and Sasol", "Top-up bonus of 500 ManshyaPoints when you spend R500 in a single fuel transaction", "Monthly fuel rewards statement"] },
];
...
const ROW2 = [
  ...
  },
  {
    ...
    features: [
      "3× ManshyaPoints on flights and hotels",
  ...
  },
  {
    ...
    features: [
      "Earn ManshyaPoints at Tiger Wheel & Tyre, Supa Quick, and AutoZone",
...
export function RewardsViewer({ isOpen, onClose }: Props) {
  return (
    <PricingViewer
      ...
      heroTitle="ManshyaPoints — Rewards That Move With You"
