        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
          <div className="text-center md:text-left">
            ...
            <p className="text-white/70 text-sm leading-relaxed mb-6 max-w-sm mx-auto md:mx-0">
              Your MANSHYA card is accepted at millions of merchant locations in over 175 countries — and across every major taxi route, fuel station, and retailer in South Africa. Tap-to-pay and contactless payments work instantly at partner merchants.
            </p>
