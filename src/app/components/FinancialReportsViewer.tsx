/**
 * MANSHYA Financial Reports System
            ...
            <div className="bg-white rounded-2xl border border-gray-200 shadow-sm overflow-hidden print:shadow-none print:border-0">
              ...
              <div className="px-8 py-5 space-y-1">
                ...
                <p className="text-[10px] text-gray-400 text-center mt-4">
                  This payslip is a certified financial record generated by MANSHYA Bank · Authorised Financial Services Provider (NCRCP)
          ...
          <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-6">
            <div className="flex items-start justify-between mb-6">
              <div>
                ...
                <p className="text-xs text-gray-500 mt-0.5">MANSHYA / MANSHYA Taxi Operations — {is.periodStart} to {is.periodEnd}</p>
              </div>
            ...
            <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-6">
              <div className="flex items-start justify-between mb-6 flex-wrap gap-3">
                <div>
                  ...
                  <p className="text-xs text-gray-500 mt-0.5">MANSHYA / MANSHYA Taxi Operations — As at {String(bs.asAt)}</p>
                </div>
          ...
          <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-6">
            <div className="flex items-start justify-between mb-6 flex-wrap gap-3">
              <div>
                ...
                <p className="text-xs text-gray-500 mt-0.5">MANSHYA / MANSHYA Taxi Operations — {cf.periodStart} to {cf.periodEnd}</p>
              </div>
