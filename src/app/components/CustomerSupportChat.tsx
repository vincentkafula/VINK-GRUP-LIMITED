...
const INITIAL_MESSAGES: Message[] = [
  {
    id: "sys1",
    role: "system",
    text: "🟢 MANSHYA Support is online — Average response time: under 2 minutes",
    timestamp: new Date(),
  },
  {
    id: "bot1",
    role: "bot",
    text: "Hi! I'm Viva, your MANSHYA virtual assistant. I can help you with:\n\n• Account balances & transactions\n• Card freezing & limits\n• Loan application status\n• Club Travel bookings\n• Branch & ATM locator\n\nWhat can I help you with today?",
    timestamp: new Date(),
  },
];
    ...
    >
      ...
      <div className="flex items-center gap-3 px-4 py-3 border-b border-white/10" style={{ background: `linear-gradient(135deg,${P},#5FC97F)` }}>
        ...
        <div className="flex-1">
          <p className="text-white font-bold text-sm">MANSHYA Support</p>
      ...
      <div className="px-4 py-2 border-t border-white/5 flex items-center justify-center gap-2">
        <span className="text-[10px] text-white/25">Powered by MANSHYA AI · All conversations are recorded for quality</span>
      </div>
    </div>
  );
}
