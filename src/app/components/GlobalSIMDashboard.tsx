...
const MVNO_PARTNERS = [
  {
    ...
    feature: "VINK AFC payment integration on all SA networks",
  },
  {
  ...
  },
  {
    ...
    internationalTermination: "US domestic routing — ACH billing to VINK",
...
const SIM_PLANS = [
  {
    ...
    features: ["Zero monthly fee", "Top up as needed", "Calls to 5 countries at local rates", "VINK app data free"],
  },
  {
    ...
    features: ["1GB data", "50 mins SA calls", "50 SMS", "20 mins international (local rates)", "VINK app data free", "30-day data rollover"],
  },
  {
  ...
  },
  {
    ...
    features: ["10GB data", "200 mins SA calls", "200 SMS", "120 mins international (local rates)", "All VINK app data free", "Wi-Fi calling", "eSIM included"],
  },
  {
...
const CALL_SCENARIOS = [
  {
    ...
    vink: "SA Cell C → VINK EU routing → Teliqo UK local termination\nCost: R0.80/min (local EU rate)",
    saving: "90% cheaper",
    color: "#10B981",
  },
  {
    ...
    vink: "Airtel ZM → VINK US routing → T-Mobile local termination\nCost: K0.60/min (local US rate)",
    saving: "92% cheaper",
    color: "#3B82F6",
  },
  {
    ...
    vink: "Teliqo EU → VINK CN routing → China Unicom local termination\nCost: €0.03/min (local CN rate)",
    saving: "91% cheaper",
    color: "#F5A623",
  },
];
            ...
            <div className="space-y-5 max-w-3xl">
              ...
              <div className="bg-white rounded-2xl border border-gray-100 p-5 space-y-3">
                ...
                {[
                  ...
                  { label: "VINK app data free",        enabled: MY_SIM.vinkDataFree, sub: "Banking, payments, tracking — zero data cost" },
