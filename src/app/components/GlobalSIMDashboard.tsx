/**
 * MANSHYA Global SIM Card System
 *
 * Architecture mirrors the Global Banking Card System:
 * One MANSHYA SIM number → 5-country MVNO partner network → local call routing everywhere
 *
 * When a MANSHYA SIM user calls any number in the world, the call is routed through
 * MANSHYA's local MVNO partner in the destination country — billed as a LOCAL call.
...
const MVNO_PARTNERS = [
  {
    ...
    feature: "MANSHYA AFC payment integration on all SA networks",
  },
  {
  ...
  },
  {
    ...
    internationalTermination: "US domestic routing — ACH billing to MANSHYA",
...
const SIM_PLANS = [
  {
    ...
    features: ["Zero monthly fee", "Top up as needed", "Calls to 5 countries at local rates", "MANSHYA app data free"],
  },
  {
    ...
    features: ["1GB data", "50 mins SA calls", "50 SMS", "20 mins international (local rates)", "MANSHYA app data free", "30-day data rollover"],
  },
  {
    ...
    features: ["3GB data", "100 mins SA calls", "100 SMS", "60 mins international (local rates)", "MANSHYA app + banking data free", "Wi-Fi calling (VoWiFi)"],
    featured: true,
  },
  {
    ...
    features: ["10GB data", "200 mins SA calls", "200 SMS", "120 mins international (local rates)", "All MANSHYA app data free", "Wi-Fi calling", "eSIM included"],
  },
  {
    ...
    features: ["5GB data", "UNLIMITED SA calls", "300 SMS", "300 mins international (local rates)", "All MANSHYA app data free", "HD voice (VoLTE)", "eSIM + physical SIM"],
  },
];
...
const CALL_SCENARIOS = [
  {
    ...
    vink: "SA Cell C → MANSHYA EU routing → Teliqo UK local termination\nCost: R0.80/min (local EU rate)",
    saving: "90% cheaper",
    color: "#10B981",
  },
  {
    ...
    vink: "Airtel ZM → MANSHYA US routing → T-Mobile local termination\nCost: K0.60/min (local US rate)",
    saving: "92% cheaper",
    color: "#3B82F6",
  },
  {
    ...
    vink: "Teliqo EU → MANSHYA CN routing → China Unicom local termination\nCost: €0.03/min (local CN rate)",
    saving: "91% cheaper",
    color: "#F5A623",
  },
];
    ...
    <div className="fixed inset-0 z-50 flex flex-col bg-gray-50">
      ...
      <div className="flex items-center justify-between px-5 py-3 bg-white border-b border-gray-200 shadow-sm flex-shrink-0 z-10">
        <div className="flex items-center gap-3">
          ...
          <div>
            <p className="text-sm font-black text-gray-900 leading-none">MANSHYA Global SIM · MVNO System</p>
        ...
        <main className="flex-1 overflow-y-auto px-5 py-5">
              ...
              <div className="bg-white rounded-2xl border border-gray-100 p-5">
                ...
                <div className="flex flex-col items-center gap-2">
                  <div className="w-full rounded-xl p-3 text-center text-white text-sm font-bold" style={{ background: P }}>
                    MANSHYA SIM (Single MSISDN · One account · All countries)
                  </div>
                    ...
                    <div key={i} className="rounded-xl border border-gray-100 overflow-hidden">
                      ...
                      <div className="grid sm:grid-cols-2 divide-y sm:divide-y-0 sm:divide-x divide-gray-100">
                        ...
                        <div className="px-4 py-3" style={{ background: s.color + "06" }}>
                          <p className="text-[10px] font-bold uppercase tracking-wide mb-1" style={{ color: s.color }}>✓ MANSHYA Local Routing</p>
          ...
          {screen === "partners" && (
            <div className="space-y-5 max-w-5xl">
              ...
              <div className="bg-emerald-50 border border-emerald-200 rounded-xl p-4 text-sm text-emerald-800 leading-relaxed">
                <strong>How it works:</strong> MANSHYA holds an MVNO (Mobile Virtual Network Operator) agreement with a licensed host network in each country. When a MANSHYA SIM user is in — or calls to — that country, their traffic is routed through the local operator's infrastructure. The call is billed at domestic rates. MANSHYA pays the local partner a wholesale interconnect fee and charges the customer a transparent margin. No international fees pass through.
              </div>
              <div className="space-y-4">
                {MVNO_PARTNERS.map(p => (
          ...
          {screen === "mysim" && (
            <div className="space-y-5 max-w-3xl">
              <h1 className="text-xl font-black text-gray-900">My MANSHYA SIM</h1>
              ...
              <div className="rounded-2xl overflow-hidden shadow-xl text-white relative"
                ...
                <div className="p-6 relative z-10">
                  <div className="flex items-start justify-between">
                    <div>
                      <p className="text-[10px] opacity-60 uppercase tracking-widest">MANSHYA GLOBAL SIM</p>
              ...
              <div className="bg-white rounded-2xl border border-gray-100 p-5 space-y-3">
                ...
                {[
                  ...
                  { label: "MANSHYA app data free",        enabled: MY_SIM.vinkDataFree, sub: "Banking, payments, tracking — zero data cost" },
            ...
            <div className="space-y-5 max-w-4xl">
              ...
              <div className="bg-white rounded-2xl border border-gray-100 p-6 space-y-5">
                ...
                <div className="grid sm:grid-cols-2 gap-4">
                  ...
                  <div className="rounded-2xl p-5 border-2 border-green-200 bg-green-50">
                    <p className="text-xs font-bold text-green-600 uppercase tracking-wide mb-2">✓ MANSHYA Local Routing</p>
                    ...
                    <p className="text-[10px] text-green-500 mt-2">Routed via MANSHYA {toPartner?.partner} — local termination, no IDD fees</p>
                  </div>
                </div>
              ...
              <div className="bg-white rounded-2xl border border-gray-100 p-5">
                ...
                <div className="relative pl-6 border-l-2" style={{ borderColor: P }}>
                  {[
                    { step: "1", title: "Call initiated", desc: `You dial a ${toPartner?.country} number from your MANSHYA SIM in ${fromPartner?.country}.`, icon: "📱" },
                    { step: "2", title: "Authentication", desc: "MANSHYA network validates your MSISDN and checks available balance/plan minutes.", icon: "🔐" },
                    { step: "3", title: "Routing decision", desc: `MANSHYA routing engine identifies the destination country (${toPartner?.country}) and selects the local MVNO partner: ${toPartner?.partner}.`, icon: "🔀" },
                    ...
                    { step: "6", title: "Billing", desc: `Your MANSHYA balance is debited at the local ${toPartner?.country} rate (${toPartner?.localCallRate}). MANSHYA pays the partner wholesale interconnect fee. No international tariff applied.`, icon: "💳" },
                  ].map((s, i) => (
