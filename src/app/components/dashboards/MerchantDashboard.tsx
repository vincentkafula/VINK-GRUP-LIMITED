...
const TOP_PRODUCTS = [
  { name: "MANSHYA SIM Card Bundle", sold: 482, revenue: "R96,400", stock: 1840, rating: 4.8 },
  ...
  { name: "MANSHYA Data SIM (20GB)", sold: 284, revenue: "R56,800", stock: 920, rating: 4.6 },
];
...
export function MerchantDashboard({ isOpen, onClose }: { isOpen: boolean; onClose: () => void }) {
  ...
  return (
    <DashboardShell
      ...
      onClose={onClose} liveConnected userName="MANSHYA Commerce Ltd" alertCount={8}
    >
