            ...
            <div>
              ...
              <div className="flex gap-3">
                ...
                <div className="flex items-center gap-3 bg-white/10 rounded-xl px-4 py-2.5 opacity-55">
                  ...
                  <div>
                    <p className="text-white/55 text-[9px] leading-none">App Store</p>
                    <p className="text-white text-xs font-semibold leading-snug mt-0.5">Coming Soon</p>
                  </div>
                </div>
                ...
                <div className="flex items-center gap-3 bg-white/10 rounded-xl px-4 py-2.5 opacity-55">
                  ...
                  <div>
                    <p className="text-white/55 text-[9px] leading-none">Google Play</p>
                    <p className="text-white text-xs font-semibold leading-snug mt-0.5">Coming Soon</p>
                  </div>
                </div>
              </div>
