...
export const PRODUCTS: Record<ProductCategory, Product[]> = {
  ...
  insure: [
    ...
    { id: "funeral", name: "VINK ShieldOne", tagline: "Comprehensive everyday personal protection.", price: "R85", priceLabel: "/month", emoji: "🌹", gradient: "linear-gradient(135deg,#F3E5F5,#E1BEE7)", features: ["All-in-one cover for accidents, personal liability, and everyday risks", "Single premium, single policy, single point of contact", "Flexible cover levels that scale with life stage and income", "24/7 claims support with fast-track digital claims", "Optional add-ons to tailor protection to your household"] },
  ...
  rewards: [
    ...
    { id: "retail-rewards", name: "ThriveClub", tagline: "A wellness-linked rewards programme that rewards healthy habits and positive lifestyle choices.", price: "R170", priceLabel: "/month", emoji: "🛒", gradient: "linear-gradient(135deg,#F3E5F5,#E1BEE7)", features: ["Double VinkPoints at Pick n Pay, Shoprite, Checkers & Spar", "Redeem in-store or on the VINK app", "Selected independent retailers included", "Points never expire while account is active"] },
  ...
  creditCard: [
    ...
    { id: "investment-cc", name: "Elevate Card", tagline: "A card built for upwardly mobile professionals, combining everyday value with premium lifestyle perks.", price: "R170", priceLabel: "/month", emoji: "📈", gradient: "linear-gradient(135deg,#F3E5F5,#E1BEE7)", features: ["1% of every purchase to a linked unit trust", "Quarterly investment statements", "Linked to Allan Gray or Coronation", "Travel insurance included"] },
