...
export const PRODUCTS: Record<ProductCategory, Product[]> = {
  ...
  rewards: [
    { id: "balance-transfer", name: "Balance Transfer Card", tagline: "Cut your interest — move your debt to VINK", price: "R0", priceLabel: "/month", emoji: "🔄", gradient: "linear-gradient(135deg,#E8F5E9,#C8E6C9)", features: ["0% interest for 6 months on transferred balance", "3% transfer fee (minimum R50)", "No annual fee", "Reports to all 4 credit bureaux"] },
  ...
  creditCard: [
    ...
    { id: "co-branded", name: "Co-Branded (VINK × PnP)", tagline: "Earn Smart Shopper points at Pick n Pay", price: "R85", priceLabel: "/month", emoji: "🛒", gradient: "linear-gradient(135deg,#FFF8E1,#FFF3CD)", features: ["Earn 1 Smart Shopper point per R5 at PnP", "0.5% cashback everywhere else", "R0 transaction fees at PnP tills", "Exclusive monthly bonus offers"] },
