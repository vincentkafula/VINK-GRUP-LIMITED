...
export const PRODUCTS: Record<ProductCategory, Product[]> = {
  account: [
    ...
    { id: "premier", name: "Horizon Account", tagline: "For high-earners who need premium everyday banking", price: "R170", priceLabel: "/month", emoji: "💎", gradient: "linear-gradient(135deg,#F3E5F5,#E1BEE7)", features: ["10 free ATM withdrawals at any bank", "1% cashback on all spend", "R15,000 overdraft facility", "Travel notifications included"] },
  ...
  invest: [
    { id: "tfsa", name: "NovaWealth", tagline: "Zero tax on growth — the most tax-efficient way to save", price: "R0", priceLabel: "admin fee", emoji: "🛡️", gradient: "linear-gradient(135deg,#E3F2FD,#BBDEFB)", badge: "Best for Beginners", badgeColor: "#10B981", features: ["Zero tax on interest, dividends, and capital gains", "R36,000 annual contribution limit", "Access your funds any time", "Linked to VINK money market fund"] },
    { id: "fixed-3m", name: "HorizonPlus", tagline: "Lock in and earn — short-term security", price: "7.2%", priceLabel: "p.a. indicative rate", emoji: "🔒", gradient: "linear-gradient(135deg,#E8F5E9,#C8E6C9)", features: ["3-month lock-in period", "Interest paid at maturity", "No monthly fees", "Early exit penalty of 1% applies"] },
    { id: "fixed-12m", name: "ProsperNest", tagline: "Maximum short-term return with certainty", price: "9.5%", priceLabel: "p.a. indicative rate", emoji: "📈", gradient: "linear-gradient(135deg,#E8F5E9,#A5D6A7)", featured: true, badge: "Best Rate", badgeColor: "#F5A623", features: ["12-month lock-in period", "Interest credited monthly or at maturity", "No monthly fees", "Guaranteed rate at opening"] },
    { id: "unit-trust", name: "InfinityGrowth", tagline: "Professionally managed diversified growth", price: "R500", priceLabel: "minimum/month", emoji: "📊", gradient: "linear-gradient(135deg,#FFF8E1,#FFF3CD)", features: ["Diversified across equity, bonds, and property", "Managed by qualified portfolio team", "Monthly or lump-sum contributions", "Quarterly investment statements"] },
    { id: "ra", name: "Evergreen Portfolio", tagline: "Build your retirement while saving tax today", price: "27.5%", priceLabel: "of income tax-deductible", emoji: "🎯", gradient: "linear-gradient(135deg,#F3E5F5,#E1BEE7)", features: ["Tax-deductible contributions up to 27.5% of income", "Lump-sum or monthly contributions", "Choice of underlying fund", "Portable between employers"] },
    { id: "money-market", name: "LegacyBuilder", tagline: "Emergency fund earning daily interest", price: "R0", priceLabel: "no minimum balance", emoji: "💰", gradient: "linear-gradient(135deg,#E0F2F1,#B2DFDB)", features: ["Instant access", "Daily interest accrual", "Rate linked to repo rate", "No minimum balance required"] },
  ],
  insure: [
    { id: "life", name: "VINK LifeNest", tagline: "Protect your family's financial future", price: "R0", priceLabel: "admin fee · premium from R89/month", emoji: "❤️", gradient: "linear-gradient(135deg,#FFEBEE,#FFCDD2)", badge: "Most Important", badgeColor: "#EF4444", features: ["R100,000 – R10,000,000 cover", "No medical exam for cover under R1M", "Beneficiary payout within 48 hours", "Instant online application"] },
    { id: "disability", name: "VINK SecureStride", tagline: "Income protection if you can't work", price: "R0", priceLabel: "admin fee · premium from R59/month", emoji: "🦺", gradient: "linear-gradient(135deg,#FFF8E1,#FFF3CD)", features: ["Monthly income protection", "Covers taxi drivers and informal workers", "Claims assessed within 5 business days", "Linked to your Vink wallet"] },
    { id: "funeral", name: "VINK ShieldOne", tagline: "Instant payout for your whole family", price: "R85", priceLabel: "/month", emoji: "🌹", gradient: "linear-gradient(135deg,#F3E5F5,#E1BEE7)", features: ["Covers you and up to 9 family members", "Payout within 24 hours of claim", "R5,000 – R50,000 benefit", "Includes grocery and airtime allowance"] },
    { id: "home-contents", name: "VINK HomeHarbour", tagline: "Protect your belongings against theft and damage", price: "R170", priceLabel: "/month", emoji: "🏠", gradient: "linear-gradient(135deg,#E8F5E9,#C8E6C9)", features: ["Covers theft, fire, flood, and accidental damage", "Replacement value — not book value", "Fast online claims via VINK app", "No fixed-term contract"] },
    { id: "motor", name: "VINK JourneyGuard", tagline: "Comprehensive cover for your vehicle", price: "R265", priceLabel: "/month", emoji: "🚗", gradient: "linear-gradient(135deg,#E3F2FD,#BBDEFB)", featured: true, badge: "Most Chosen", badgeColor: "#F5A623", features: ["Comprehensive or third-party cover", "Roadside assist included", "No-claims bonus after 12 months", "Linked to Vink Driver Card for taxi operators"] },
    { id: "hospital-cash", name: "VINK CareCircle", tagline: "Daily cash while you're in hospital", price: "R415", priceLabel: "/month", emoji: "🏥", gradient: "linear-gradient(135deg,#E0F2F1,#B2DFDB)", features: ["R500 – R2,000 per day while hospitalised", "No network restrictions", "Covers maternity and planned procedures", "Payout direct to your Vink account"] },
  ],
  rewards: [
    { id: "balance-transfer", name: "LifePerks", tagline: "Cut your interest — move your debt to VINK", price: "R0", priceLabel: "/month", emoji: "🔄", gradient: "linear-gradient(135deg,#E8F5E9,#C8E6C9)", features: ["0% interest for 6 months on transferred balance", "3% transfer fee (minimum R50)", "No annual fee", "Reports to all 4 credit bureaux"] },
    { id: "cash-back", name: "SparkRewards", tagline: "Earn on every purchase — automatically", price: "R0", priceLabel: "/month", emoji: "💵", gradient: "linear-gradient(135deg,#E3F2FD,#BBDEFB)", features: ["1% cashback on all spend", "Capped at R500/month", "Credited last day of each month", "No minimum spend required"] },
    { id: "fuel-rewards", name: "NovaPoints", tagline: "Earn on every litre at every station", price: "R85", priceLabel: "/month", emoji: "⛽", gradient: "linear-gradient(135deg,#FFF8E1,#FFF3CD)", features: ["Earn 8c per litre at Engen, Shell & Sasol", "500 VinkPoints bonus per R500 fuel spend", "Monthly fuel rewards statement", "Use points for any purchase"] },
    { id: "retail-rewards", name: "ThriveClub", tagline: "Double points at SA's biggest grocery chains", price: "R170", priceLabel: "/month", emoji: "🛒", gradient: "linear-gradient(135deg,#F3E5F5,#E1BEE7)", features: ["Double VinkPoints at Pick n Pay, Shoprite, Checkers & Spar", "Redeem in-store or on the VINK app", "Selected independent retailers included", "Points never expire while account is active"] },
    { id: "travel-rewards", name: "ElevateRewards", tagline: "Earn 3× points on flights and hotels", price: "R265", priceLabel: "/month", emoji: "✈️", gradient: "linear-gradient(135deg,#7B1FA2,#AB47BC)", featured: true, badge: "Top Pick", badgeColor: "#F5A623", features: ["3× VinkPoints on flights and hotels", "Access to Bidvest Lounges at all SA airports", "Travel insurance on bookings", "Airline partners: Comair and FlySafair"] },
    { id: "automotive-rewards", name: "JourneyPoints", tagline: "Earn on services at top fitment centres", price: "R415", priceLabel: "/month", emoji: "🔧", gradient: "linear-gradient(135deg,#212121,#424242)", features: ["Earn VinkPoints at Tiger Wheel & Tyre, Supa Quick & AutoZone", "Redeem for oil changes, tyres, and services", "Monthly automotive spend report", "Linked to fleet management tools"] },
  ],
  loan: [
    { id: "personal", name: "LifeAdvance", tagline: "Quick cash for life's unexpected needs", price: "R0", priceLabel: "application fee", emoji: "👤", gradient: "linear-gradient(135deg,#FFEBEE,#FFCDD2)", badge: "Same-day Approval", badgeColor: "#10B981", features: ["R1,000 – R250,000", "12–60 month terms", "Interest rate 12.5%–24.5% p.a.", "Same-day approval for qualifying applicants"] },
    { id: "home-loan", name: "FlexiLoan", tagline: "Own your home — 100% financing available", price: "R0", priceLabel: "application fee", emoji: "🏠", gradient: "linear-gradient(135deg,#E8F5E9,#C8E6C9)", features: ["Up to 100% LTV for first-time buyers", "20-year term available", "Linked to prime rate", "Free property valuation included"] },
    { id: "student-loan", name: "HorizonLoan", tagline: "Fund your education — repay after graduation", price: "R85", priceLabel: "admin fee", emoji: "🎓", gradient: "linear-gradient(135deg,#E3F2FD,#BBDEFB)", features: ["Covers tuition, textbooks, and accommodation", "Repayment deferred until 6 months post-graduation", "All public universities in SA eligible", "No collateral required"] },
    { id: "pension-backed", name: "SwiftCash", tagline: "Use your pension fund as collateral", price: "R170", priceLabel: "admin fee", emoji: "🏦", gradient: "linear-gradient(135deg,#FFF8E1,#FFF3CD)", features: ["Up to 90% of pension fund value", "No credit check required", "Any registered pension fund in SA", "Lower interest rate than unsecured loans"] },
    { id: "vehicle-loan", name: "DreamFund", tagline: "New or used — we finance up to 100%", price: "R265", priceLabel: "admin fee", emoji: "🚗", gradient: "linear-gradient(135deg,#B71C1C,#E53935)", featured: true, badge: "Most Chosen", badgeColor: "#F5A623", features: ["New and used vehicles", "Finance up to 100%", "Balloon payment option available", "Linked VINK vehicle insurance option", "12–72 month terms"] },
    { id: "vehicle-leasing", name: "ElevateLoan", tagline: "Drive without owning — fully maintained", price: "R415", priceLabel: "admin fee", emoji: "🔑", gradient: "linear-gradient(135deg,#37474F,#546E7A)", features: ["Operating or finance lease", "Maintenance, tyres, and licensing included", "Fixed monthly cost", "Residual value guaranteed", "Ideal for personal and business"] },
  ],
  creditCard: [
    { id: "student", name: "Pulse Card", tagline: "Build your credit history from day one", price: "R0", priceLabel: "/month", emoji: "🎓", gradient: "linear-gradient(135deg,#E3F2FD,#BBDEFB)", badge: "No Annual Fee", badgeColor: "#10B981", features: ["Credit limit R1,000 – R5,000", "Credit-builder reporting to all 4 bureaux", "0.5% cashback on study and grocery spend", "Free online statements"] },
    { id: "secure", name: "Nova Card", tagline: "Secured card with a clear upgrade path", price: "R0", priceLabel: "/month", emoji: "🔐", gradient: "linear-gradient(135deg,#E8F5E9,#C8E6C9)", features: ["Secured by a deposit you choose", "Upgrade to unsecured after 12 months", "Reports to all credit bureaux", "Free replacement card"] },
    { id: "co-branded", name: "Orbit Card", tagline: "Earn Smart Shopper points at Pick n Pay", price: "R85", priceLabel: "/month", emoji: "🛒", gradient: "linear-gradient(135deg,#FFF8E1,#FFF3CD)", features: ["Earn 1 Smart Shopper point per R5 at PnP", "0.5% cashback everywhere else", "R0 transaction fees at PnP tills", "Exclusive monthly bonus offers"] },
    { id: "investment-cc", name: "Elevate Card", tagline: "Every purchase grows your investment", price: "R170", priceLabel: "/month", emoji: "📈", gradient: "linear-gradient(135deg,#F3E5F5,#E1BEE7)", features: ["1% of every purchase to a linked unit trust", "Quarterly investment statements", "Linked to Allan Gray or Coronation", "Travel insurance included"] },
    { id: "grain-cc", name: "Apex Card", tagline: "Premium rewards for premium spenders", price: "R265", priceLabel: "/month", emoji: "🏆", gradient: "linear-gradient(135deg,#4A148C,#7B1FA2)", featured: true, badge: "Premium Choice", badgeColor: "#F5A623", features: ["Airport lounge access — 1,000+ lounges", "2% cashback on travel · 1% everywhere", "Credit limit up to R500,000", "Dedicated concierge service", "Medical emergency cover"] },
    { id: "animal-cc", name: "Vertex Card", tagline: "Elite benefits for discerning cardholders", price: "R415", priceLabel: "/month", emoji: "🦁", gradient: "linear-gradient(135deg,#1A1A1A,#4A4A4A)", features: ["R1,000,000 credit limit", "3% cashback on international spend", "Personal concierge 24/7", "Global medical emergency evacuation", "Earn up to 120,000 VinkPoints/year"] },
  ],
  sim: [
    ...
    { id: "plus-10gb", name: "Plus 10GB", tagline: "Serious data for busy lifestyles", price: "R199", priceLabel: "/month", emoji: "🚀", gradient: "linear-gradient(135deg,#F3E5F5,#E1BEE7)", featured: true, badge: "Best Value", badgeColor: "#F5A623", features: ["10GB data included", "200 free SMS", "100 free minutes", "Free Vink app data", "Free Wi-Fi on VINK taxis"] },
