...
export const CATEGORY_CONFIG: Record<ProductCategory, {
  ...
  creditCard: {
    title: "Choose Your MANSHYA Card",
...
export const PRODUCTS: Record<ProductCategory, Product[]> = {
  account: [
    { id: "clear-access", name: "Spark Account", tagline: "For anyone starting their banking journey", price: "R0", priceLabel: "/month — always free", emoji: "🌱", gradient: "linear-gradient(135deg,#E3F2FD,#BBDEFB)", features: ["No minimum balance", "Free MANSHYA card included", "Instant transaction notifications", "Online and app banking"], badge: "Free Forever", badgeColor: "#10B981" },
    ...
    <div className="fixed inset-0 z-50 flex flex-col overflow-y-auto bg-[#F8F7FF]">
      ...
      <div className="max-w-5xl mx-auto w-full px-5 py-8">
        ...
        <p className="text-center text-xs text-gray-400 mt-6">
          Not sure which to choose? <span className="underline cursor-pointer" style={{ color: cfg.accentColor }}>Compare all products</span> or speak to a MANSHYA advisor at 0800 MANSHYA (8465).
        </p>
      </div>
