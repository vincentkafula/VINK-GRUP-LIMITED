      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12">
          ...
          <p className="text-muted-foreground max-w-2xl mx-auto">
            Real stories from real people who love using MANSHYA
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-3 gap-8">
          <TestimonialCard
            ...
            image="SJ"
            rating={5}
            text="MANSHYA has transformed how I manage my business finances. The cashback rewards are incredible, and the customer service is always there when I need them."
          />
          <TestimonialCard
            name="Michael Chen"
            ...
            image="MC"
            rating={5}
            text="I've tried many credit cards, but MANSHYA is by far the best. No hidden fees, great rewards, and the mobile app is so easy to use. Highly recommend!"
          />
          <TestimonialCard
