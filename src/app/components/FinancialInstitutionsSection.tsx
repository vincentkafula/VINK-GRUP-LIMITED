const PARTNERS = [
  ...
  { name: "Mercantile Bank", logo: <svg viewBox="0 0 140 30" className="h-7 w-36"><rect x="0" y="3" width="22" height="24" rx="3" fill="#0B5C2E"/><text x="3" y="21" fontSize="13" fontWeight="900" fill="white" fontFamily="Arial">MB</text><text x="28" y="21" fontSize="12" fontWeight="700" fill="#0B5C2E" fontFamily="Arial">Mercantile Bank</text></svg> },
